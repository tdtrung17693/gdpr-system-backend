  ...
  public class ApplicationDbContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      foreach (var entityType in modelBuilder.Model.GetEntityTypes())
      {
        ...
        if (entityType.ClrType.Name == "SPRequestResultView" ||
            entityType.ClrType.Name == "SPRequestResultExportView") continue;
    ...
    private void AddAuitInfo()
    {
      ...
      foreach (var entry in entries)
      {
        ...
        ((BaseEntity) entry.Entity).Status =
          ((BaseEntity) entry.Entity).Status == null ? false : ((BaseEntity) entry.Entity).Status;
      }
    }
  }
}
