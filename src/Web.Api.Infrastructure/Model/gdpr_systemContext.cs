...
{
    public partial class gdpr_systemContext : DbContext
    {
        public gdpr_systemContext()
        {
        }

        public gdpr_systemContext(DbContextOptions<gdpr_systemContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-CI6H5AL;Database=gdpr_system;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasIndex(e => e.Username)
                    .HasName("UQ__Account__536C85E4985DA26F")
                    .IsUnique();
            ...
            modelBuilder.Entity<CustomerServer>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.ServerId })
                    .HasName("PK__Customer__D8F8C8565CCFD9F8");
            ...
            modelBuilder.Entity<PermissionRole>(entity =>
            {
                entity.HasKey(e => new { e.RoleId, e.PermissionId })
                    .HasName("PK__Permissi__6400A1A8BFE02524");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__User__A9D1053464B727BA")
                    .IsUnique();
            ...
            modelBuilder.Entity<UserFileInstance>(entity =>
            {
                entity.HasKey(e => new { e.UserId, e.FileInstanceId })
                    .HasName("PK__UserFile__6CBD43979B8A29B2");
