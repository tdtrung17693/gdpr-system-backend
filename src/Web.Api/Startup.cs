...
namespace Web.Api
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy(MyAllowSpecificOrigins, build =>
                {
                    build.WithOrigins(
                            "http://localhost:3000",
            ...
            builder.RegisterType<NewRequestWebNotification>().As<NewRequestWebNotification>()
                .InstancePerLifetimeScope();
            builder.RegisterType<NewRequestSlackNotification>().As<NewRequestSlackNotification>()
                .InstancePerLifetimeScope();
            builder.RegisterType<BroadcastNewNotifications>().As<BroadcastNewNotifications>()
                .InstancePerLifetimeScope();
